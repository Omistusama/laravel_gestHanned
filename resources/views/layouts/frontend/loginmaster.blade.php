...
<head>
  ...
  <title>Hanned Cotisation | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{asset('style/frontend/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Hanned</b>Cotisation</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
